    ...
    <div class="row category-wrap">
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-2">
            ...
            <section id="filter-cate-sbox" class="common-sbox filter-cate-sbox">
                ...
                <div class="sbox-main">
                    <div class="filter-panel is-show" data-attr="<?= Product::WEBSITE ?>">
                        <div class="panel-head">Nơi bán</div>
                        <div class="remove-block"></div>
                        <div class="panel-main">
                            <?php  foreach ($websites as $website): ?>
                                <a class="filter-item" href="javascript:void(0)" data-value="<?= $website['_id']['website_name'] ?>">
                                    <span class="icon"></span>
                                    <span class="title"><?= $website['_id']['website_name'] ?></span>
                                    <span class="count"> (<?= $website['count'] ?>) </span>
                                </a>
                            <?php endforeach; ?>
                        </div><!-- .panel-main -->
                    </div>
                    <div class="filter-panel is-show review" data-attr="<?= Product::REVIEW?>">
                        <div class="panel-head">Đánh giá</div>
                        <div class="remove-block"></div>
                        <div class="panel-main">
                            <div class="star">
                                <a href="javascript:void()" class="filter-item" data-value="<?= Product::REVIEW_5_STAR ?>">
                            ...
                            <div class="star">
                                <a href="javascript:void()" class="filter-item" data-value="<?= Product::REVIEW_4_STAR ?>">
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                            ...
                            <div class="star">
                                <a href="javascript:void()" class="filter-item" data-value="<?= Product::REVIEW_3_STAR ?>">
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                                    <span class="far fa-star"></span>
                            ...
                            <div class="star">
                                <a href="javascript:void()" class="filter-item" data-value="<?= Product::REVIEW_2_STAR ?>">
                                    <span class="fas fa-star"></span>
                                    <span class="fas fa-star"></span>
                                    <span class="far fa-star"></span>
                                    <span class="far fa-star"></span>
                            ...
                            <div class="star">
                                <a href="javascript:void()" class="filter-item" data-value="<?= Product::REVIEW_1_STAR ?>">
                                    <span class="fas fa-star"></span>
                                    <span class="far fa-star"></span>
                                    <span class="far fa-star"></span>
                                    <span class="far fa-star"></span>
            ...
            <div class="product-wrap row">
                <?php foreach ($models as $product): ?>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 product-block">
                        ...
                        <div class="website">
                            Nơi bán: <a href="<?= $product['aff_url'] ?>" target="_blank"><?= $product['website_name'] ?></a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
